module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-non-null-assertion': 'warn', // forbid non-null assertion operators for safer code; you can always `?? UnexpectedCodePathError.throw(...)` to fail fast instead
    ...
    '@typescript-eslint/no-explicit-any': 'warn', // forbid any type for better type safety; you can use `never` or `unknown` instead when its truly unknown or never needed to be known
